...
namespace PtGui
{
	partial class frmMiscMalfNBCD
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMiscMalfNBCD));
			...
			this.label6.Text = "FLOOD IN FAMR";
			...
			this.label11.Text = "DOOR OPEN/CLOSED ZONE 3 - 4";
			...
			this.label10.Text = "DOOR OPEN/CLOSED ZONE 2 - 3";
			...
			this.label9.Text = "FIRE IN FWD SWITCH BOARD ROOM";
			...
			this.label8.Size = new System.Drawing.Size(168, 48);
			this.label8.TabIndex = 0;
			this.label8.Text = "FLOOD IN AVCAT PUMP SPACE";
			...
			this.Name = "frmMiscMalfNBCD";
			this.Text = "NBCD Malfunctions";
