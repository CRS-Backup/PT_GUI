...
namespace PtGui
{
	partial class frmMiscMalfHPAir
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMiscMalfHPAir));
			...
			this.lblPageName2.Text = "HP and LP Air, Ventilation and Fresh Water";
			...
			this.label1.Text = "HPAC No1 FAIL";
			...
			this.label2.Text = "GTR HI AIR PRESSURE LOW";
			...
			this.label3.Text = "LP AIR PRESSURE LOW";
			...
			this.label4.Text = "UAMR STARBOARD SUPPLY VET FAN TRIP";
			...
			this.label7.Text = "FAMR PORT SUPPLY VENT FAN TRIP";
			...
			this.label5.Text = "HPAC No2 FAIL";
			...
			this.label6.Text = "LPAC No1 FAIL";
			...
			this.label11.Text = "FRESH WATER HFW PUMP 2 FAIL";
			...
			this.label10.Text = "FRESH WATER HFW PUMP 1 FAIL";
			...
			this.label9.Text = "FRESH WATER CFW PUMP 2 FAIL";
			...
			this.label8.Text = "FRESH WATER CFW PUMP 1 FAIL";
			...
			this.Name = "frmMiscMalfHPAir";
			this.Text = "HP Air Malfunctions";
