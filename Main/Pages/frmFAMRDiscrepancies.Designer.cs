...
namespace PtGui
{
	partial class frmFAMRDiscrepancies
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmFAMRDiscrepancies));
			...
			this.lblPageName.Text = "FAMR Hardware Discrepancies";
			...
			this.Name = "frmFAMRDiscrepancies";
			this.Text = "FAMR Discrepancies";
